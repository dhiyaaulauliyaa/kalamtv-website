...
class PhoneHeaderFooter extends StatefulWidget {
  PhoneHeaderFooter({
    Key key,
  ...
  @override
  _PhoneHeaderFooterState createState() => _PhoneHeaderFooterState();
}

class _PhoneHeaderFooterState extends State<PhoneHeaderFooter>
  ...
  //----------------------- Footer -----------------------//
  Positioned _footer(
      double _screenHeight, double _screenWidth, BuildContext context) {
    return Positioned(
      child: Container(
